...
<div class="wrapper">
  <header class="main-header">
      ...
      <a href="/index.php/Admin/Index/index" class="logo">
        ...
        <span class="logo-lg"><img src="/Public/images/TP-shop_logo.png" width="40" height="30">&nbsp;&nbsp;<b>GWshop</b></span>
      </a>
                ...
                <li class="user-footer">
                  <div class="pull-left">
                  	<!--<a href="javascript:void(0)" data-url="<?php echo U('Index/map');?>" class="btn btn-default btn-flat model-map">网站地图</a>-->
                   	<a href="<?php echo U('Admin/admin_info',array('admin_id'=>$admin_info['id']));?>" target="rightContent" class="btn btn-default btn-flat">修改密码</a>
                   	<a href="<?php echo U('Login/logout');?>" class="btn btn-default btn-flat">安全退出</a>
                  </div>
                </li>
              </ul>
            </li>
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu"> 
	      <?php if(is_array($menu_list)): foreach($menu_list as $k=>$vo): ?><li class="treeview">
            ...
            <li class="treeview">
                <a href="javascript:void(0)">
                    <i class="fa <?php echo ($vo["icon"]); ?>"></i><span>消息管理</span><i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <li ><a href="<?php echo U('NoticeOrder/sales');?>" target='rightContent'><i class="fa fa-circle-o"></i>优惠消息</a></li>
                    <li ><a href="<?php echo U('NoticeAssistant/index');?>" target='rightContent'><i class="fa fa-circle-o"></i>客服助手</a></li>
                </ul>
            </li>
...
<section class="content-wrapper right-side" id="riframe" style="margin:0px;padding:0px;margin-left:230px;">
	...
	<footer class="main-footer">
	   ...
	   <strong>Copyright &copy; 2016 <a target="_blank" href="http://www.gnwai.com">广为网络旗下产品</a>.</strong>保留所有权利。
	</footer>
