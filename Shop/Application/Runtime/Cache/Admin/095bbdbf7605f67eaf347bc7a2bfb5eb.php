                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <?php if(is_array($comment_list)): $i = 0; $__LIST__ = $comment_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td class="text-center">
                                            <img width="20" height="20" src="/Public/images/<?php if($list[status] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('comment','comment_id','<?php echo ($list["comment_id"]); ?>','is_show',this)"/>
                                        </td>
                                        <td class="text-center"><?php echo (date('Y-m-d H:i:s',$list["add_time"])); ?></td>
                                        <td class="text-center"><?php echo ($list["ip_address"]); ?></td>

                                        <td class="text-center">
                                            <a href="<?php echo U('Admin/comments/detail',array('id'=>$list[id]));?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="编辑"><i class="fa fa-eye"></i></a>
                                            <a href="javascript:void(0);" data-href="<?php echo U('Admin/comments/del',array('id'=>$list[id]));?>" onclick="del('<?php echo ($list[comment_id]); ?>',this)" id="button-delete6" data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="删除"><i class="fa fa-trash-o"></i></a>
                                        </td>
                            ...
                            <form id="op" action="<?php echo U('Comments/op');?>" method="post">
