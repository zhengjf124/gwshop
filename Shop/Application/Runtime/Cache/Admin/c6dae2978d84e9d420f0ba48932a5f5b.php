	           ...
	           <div class="row">
	            <div class="col-sm-12">
	              <table id="list-table" class="table table-bordered table-striped">
					...
					<tbody>
					  <?php if(is_array($cat_list)): foreach($cat_list as $k=>$vo): ?><tr role="row" align="center" class="<?php echo ($vo["level"]); ?>" id="<?php echo ($vo["level"]); ?>_<?php echo ($vo["cat_id"]); ?>" <?php if($vo[level] > 1): ?>style="display:none"<?php endif; ?>>
	                     <td class="sorting_1" align="left" style="padding-left:<?php echo ($vo[level] * 5); ?>em">
	                      <?php if($vo["have_son"] == 1): ?><span class="glyphicon glyphicon-plus btn-warning"  id="icon_<?php echo ($vo["level"]); ?>_<?php echo ($vo["id"]); ?>" aria-hidden="true" onclick="rowClicked(this)" ></span>&nbsp;<?php endif; ?><span><?php echo ($vo["cat_name"]); ?></span>
					     </td>					     
	                 ...
	                 <td>                         
	                     ...
	                     <td>
	                      <a class="btn btn-primary" href="<?php echo U('Article/category',array('act'=>'edit','cat_id'=>$vo['id']));?>"><i class="fa fa-pencil"></i></a>
	                      <?php if($vo["cat_type"] != 1): ?><a class="btn btn-danger" href="javascript:void(0)" data-url="<?php echo U('Article/categoryHandle');?>" data-id="<?php echo ($vo["id"]); ?>" onclick="delfun(this)"><i class="fa fa-trash-o"></i></a>
						  <?php else: ?>
