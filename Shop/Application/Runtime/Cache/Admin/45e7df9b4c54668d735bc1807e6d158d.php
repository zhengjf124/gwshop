		              ...
		              <table id="list-table" class="table table-bordered table-striped dataTable">
						...
						<tbody>
						  <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr role="row" align="center">
		                     ...
		                     <td>
		                      <a class="btn btn-primary" href="<?php echo U('Admin/admin_info',array('admin_id'=>$vo['id']));?>"><i class="fa fa-pencil"></i></a>
		                      <?php if($vo['id'] > 1): ?><a class="btn btn-danger" href="javascript:void(0)" data-url="<?php echo U('Admin/adminHandle');?>" data-id="<?php echo ($vo["id"]); ?>" onclick="delfun(this)"><i class="fa fa-trash-o"></i></a><?php endif; ?>
							</td>
