  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
          ...
          <div class="form-group has-feedback">
          	<opinioncontrol realtime="true" opinion_name="vertify_code" default="true">
                <div class="row" style="padding-right: 65px;">
                    ...
                    <div class="col-xs-4">
                        <img id="imgVerify" style="cursor:pointer;" src="<?php echo U('verify');?>" onclick="fleshVerify();"/>
                    </div>
                </div>
            </opinioncontrol>
          </div>
	    ...
	    <div class="margin text-center">
	        <div class="copyright">
	            2014-<?php echo date('Y');?> &copy; <a href="#">GWSHOP v2.0.0</a>
	            <br/>
	            <a target="_blank" href="http://www.gnwai.com">广为网络有限公司</a>出品
	        </div>
	    </div>
    </div><!-- /.login-box -->
    <!-- jQuery 2.1.4 -->
    ...
    <script>
      ...
      function fleshVerify(){
          //重载验证码
          $('#imgVerify').attr('src','/index.php?m=Admin&c=Login&a=verify&r='+Math.floor(Math.random()*100));
      }
...
//          }
          ...
          $.ajax({
  			url:'/index.php?m=Admin&c=Login&a=login&t='+Math.random(),
			type:'post',
			dataType:'json',
