		              ...
		              <table id="list-table" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
						...
						<tbody>
						  <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr role="row" align="center">
		                     ...
		                     <td>
                                 <img width="20" height="20" src="/Public/images/<?php if($vo[status] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('Article','article_id','<?php echo ($vo["article_id"]); ?>','is_open',this)"/>
                            </td>
		                     ...
		                     <td>
		                      ...
		                      <a class="btn btn-primary" href="<?php echo U('Article/article',array('act'=>'edit','article_id'=>$vo['id']));?>"><i class="fa fa-pencil"></i></a>
		                      <a class="btn btn-danger" href="javascript:void(0)" data-url="<?php echo U('Article/aticleHandle');?>" data-id="<?php echo ($vo["id"]); ?>" onclick="delfun(this)"><i class="fa fa-trash-o"></i></a>
							</td>
