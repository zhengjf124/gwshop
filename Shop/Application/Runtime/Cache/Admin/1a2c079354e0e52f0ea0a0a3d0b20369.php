...
<style type="text/css">
	#tab_tongyong .table-bordered tr td input{display:initial;}
</style>
<!--以下是在线编辑器 代码 -->
<script type="text/javascript">
    /*
                        ...
                        <div class="tab-pane active" id="tab_tongyong">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>商品简介:</td>
                                    <td>
	                                    <textarea rows="3" cols="50" name="goods_brief"><?php echo ($goodsInfo["goods_brief"]); ?></textarea>
...
-->                                
                                ...
                                <tr>
                                    <td>本店售价:</td>
                                    <td>
                                        <input type="text" value="<?php echo ($goodsInfo["goods_price"]); ?>" name="goods_price" class="form-control" style="width:150px;" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
                                ...
                                <tr>
                                    <td>库存数量:</td>
                                    <td>
                                        <?php if($goodsInfo[id] > 0): ?><input type="text" value="<?php echo ($goodsInfo["store_count"]); ?>" class="form-control" style="width:150px;" name="store_count" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
                                        <?php else: ?>
                                ...
                                <tr>
	                                ...
	                                <!--<input type="checkbox" checked="checked" value="<?php echo ($goodsInfo["is_free_shipping"]); ?>" name="is_free_shipping"/> 包邮&nbsp;&nbsp;-->
                                        ...
                                        <input type="checkbox" checked="checked" value="<?php echo ($goodsInfo["is_hot"]); ?>" name="is_hot"/>热卖&nbsp;&nbsp;

                                        <select name="gtype">
                                            <option value="0" <?php if(($goodsInfo["gtype"]) == "0"): ?>selected<?php endif; ?>  >普通商品</option>
                                            <!--<option value="1">团购商品</option>-->
                                            <option value="2" <?php if(($goodsInfo["gtype"]) == "2"): ?>selected<?php endif; ?> >限时抢购</option>
                                        </select>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>商品详情描述:</td>
                                    <td width="85%">
										<textarea class="span12 ckeditor" id="goods_content" name="goods_desc" title=""><?php echo ($goodsInfo["goods_desc"]); ?></textarea>
