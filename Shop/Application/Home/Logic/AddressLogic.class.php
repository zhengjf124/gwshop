...
class AddressLogic extends Controller
{
    ...
    {
        if(!$field){
            $field = "id,consignee,province,city,district,address,mobile,tel,zipcode,is_default";
        }
    ...
    {
        if(!$field){
            $field = "id,consignee,province,city,district,address,mobile,tel,zipcode,mobile,is_default";
        }
